            ...
            <form action="{{ route( 'offer.store' ) }}" method="POST" 
                        ...
                        <div class="relative">
                            ...
                            id="" name="producto">
                                ...
                                @foreach ($product as $value)
                                    <option value="{{$value->id}}"{{ old('producto') == $value->id ? 'selected' : '' }}>{{ $value->name}}</option>
                                @endforeach
                            </select>
                        </div>
                ...
                <div class="flex flex-wrap -mx-3 mb-2">
                    ...
                    <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                        ...
                        rounded w-full py-3 px-3 text-flugreen-500  leading-tight 
                        focus:outline-none focus:bg-gray-700 focus:border-gray-500" 
                        id="grid-city" type="date" name="end" value="{{old('end')}}">
                        @if ($errors->first('end'))
                        <div class="bg-red-100 border border-red-400 text-red-700 px-2 py-2 
                    ...
                    <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                        ...
                        rounded w-full py-3 px-3 text-flugreen-500  leading-tight 
                        focus:outline-none focus:bg-gray-700 focus:border-gray-500" 
                        id="grid-city" type="text" name="offerPrice" value="{{old('offerPrice')}}">
