            ...
            <form action="{{ route( 'product.store' ) }}" method="POST" 
                        ...
                        <div class="relative">
                            ...
                            id="" name="subCategory">
                                ...
                                @foreach ($subCategory as $value)
                                    <option value="{{$value->id}}"{{ old('subCategory') == $value->id ? 'selected' : '' }}>{{ $value->name}}</option>
                                @endforeach
                            </select>
                        </div>
                ...
                <div class="flex flex-wrap -mx-3 mb-2">
                    ...
                    <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                        ...
                        rounded w-full py-3 px-3 text-flugreen-500  leading-tight 
                        focus:outline-none focus:bg-gray-700 focus:border-gray-500" 
                        id="grid-city" type="text" name="inventario" value="{{old('inventario')}}">
                    ...
                    <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                        ...
                        rounded w-full py-3 px-3 text-flugreen-500  leading-tight 
                        focus:outline-none focus:bg-gray-700 focus:border-gray-500" 
                        id="grid-city" type="text" name="stop" value="{{old('stop')}}">
                ...
                <div class="flex flex-wrap -mx-3 mb-2">
                    <div class="w-full md:w-1/2 px-3">
                        ...
                        focus:outline-none focus:bg-gray-700 focus:border-gray-500" >{{old('descripcion')}}</textarea>
